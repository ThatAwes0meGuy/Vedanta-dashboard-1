...
export const UploadIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 512 512"
    >
      <path d="M256 0a256 256 0 1 0 0 512A256 256 0 1 0 256 0zM135.1 217.4L242.2 117.5c3.8-3.5 8.7-5.5 13.8-5.5s10.1 2 13.8 5.5l107.1 99.9c4.5 4.2 7.1 10.1 7.1 16.3 0 12.3-10 22.3-22.3 22.3l-57.7 0 0 96c0 17.7-14.3 32-32 32l-32 0c-17.7 0-32-14.3-32-32l0-96-57.7 0c-12.3 0-22.3-10-22.3-22.3 0-6.2 2.6-12.1 7.1-16.3z" />
    </svg>
  );
};
